...
public class PopupWindowWork {
    ...
    public interface OnClickItemListener {
        ...
        void onClickBianGengLing();

        void onClickDanJiaShenBao();
    }
    ...
    private static final int MENU_BIANGENGLING = 2;
    private static final int MENU_DANJIASHENBAO = 3;
    private String[] subMenus;
    private View showView;
    private final PopupWindow pop;
    private Activity context;

    private int[] img = {R.drawable.gz_jlzf_icon, R.drawable.gz_bgsq_icon, R.drawable.gz_bgl_icon, R.drawable.gz_djsb_icon};
                ...
                public void onClick(View v) {
                    switch (v.getId()) {
                        ...
                        case MENU_ADD_OVERSEE:
                            ...
                            break;
                        case MENU_BIANGENGLING:
                            _onClickItemListener.onClickBianGengLing();
                            break;
                        case MENU_DANJIASHENBAO:
                            _onClickItemListener.onClickDanJiaShenBao();
                            break;
                        default:
                            break;
                    }
