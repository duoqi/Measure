...
public class SectionDetial implements Serializable{
    ...
    public static class AppSumChptBean implements Serializable{
        ...
        private double altIvst;
        private double finalIvst;
        private double prdIvst;
        ...
        public double getAltIvst() {
            return altIvst;
        }

        public void setAltIvst(double altIvst) {
        ...
        public double getPrdIvst() {
            return prdIvst;
        }

        public void setPrdIvst(double prdIvst) {
